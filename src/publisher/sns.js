 ...
 */
var SNSPublisher = /** @class */ (function () {
    function SNSPublisher(url, awsconfig, snsOptions) {
        aws_sdk_1.config.update(awsconfig);
        this.sns = new aws_sdk_1.SNS();
        this.url = url;
        this.snsOption = snsOptions;
    }
    SNSPublisher.prototype.publish = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var snsData, messageId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.sns.publish(snsData).promise()];
                    case 1: return [4 /*yield*/, (_a.sent()).MessageId];
                    case 2:
                        messageId = _a.sent();
                        return [2 /*return*/, messageId !== null && messageId !== undefined];
                }
            });
        });
    };
    SNSPublisher.prototype.subscribe = function (_, __) {
        return __awaiter(this, void 0, void 0, function () {
            var protocolRegex, snsParams;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        protocolRegex = RegExp(this.snsOption.protocol + ':', 'g');
                        ...
                        return [4 /*yield*/, this.sns.subscribe(snsParams).promise()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, Promise.resolve({
                                remove: function () {
                                    _this.sns.unsubscribe().promise();
