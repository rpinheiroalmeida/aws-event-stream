 ...
 */
var SQSPublisher = /** @class */ (function () {
    function SQSPublisher(url, awsconfig) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.sqs.sendMessage(sqsData).promise()];
    ...
    SQSPublisher.prototype.subscribe = function (aggregation, subscriber) {
        return __awaiter(this, void 0, void 0, function () {
            var consumer;
            return __generator(this, function (_a) {
