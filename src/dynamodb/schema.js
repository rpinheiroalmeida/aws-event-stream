...
var Schema = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.dynamoDB.createTable(this.eventsScheme()).promise()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    Schema.prototype.exists = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tables;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dynamoDB.listTables({}).promise()];
                    case 1:
                        tables = _a.sent();
                        return [2 /*return*/, tables.TableNames.filter(function (tableName) {
                                return tableName === _this.config.dynamodb.tableName;
                            }).length === 1];
                }
            });
        });
    };
    Schema.prototype.eventsScheme = function () {
        return {
